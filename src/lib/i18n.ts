export const messages = {
  de: {
    ...
    obsBadgeError: 'Fehler',
    overlayHide: 'Overlay bei Inaktivität ausblenden (Sekunden, 0 = nie)',
    settings: 'Einstellungen',
    openSettings: 'Einstellungen öffnen',
    close: 'Schließen',
    obsShortHint: 'OBS-Steuerung, Zeiger & Overlay-Optionen in den Einstellungen.',
    pointerPos: 'Zeiger-Position',
    posTop: 'Oben',
    posRight: 'Rechts',
    posBottom: 'Unten',
    posLeft: 'Links',
    obsBookmark: 'Bookmark-Link mit Passwort kopieren',
    obsBookmarkHint:
      'Der Link verbindet beim Öffnen automatisch. Das Passwort ist darin nur verschleiert, nicht sicher verschlüsselt: nur als lokales Lesezeichen verwenden, nicht teilen.',
    entries: 'Einträge',
  ...
  en: {
    ...
    obsBadgeError: 'Error',
    overlayHide: 'Hide overlay when idle (seconds, 0 = never)',
    settings: 'Settings',
    openSettings: 'Open settings',
    close: 'Close',
    obsShortHint: 'OBS control, pointer & overlay options live in the settings.',
    pointerPos: 'Pointer position',
    posTop: 'Top',
    posRight: 'Right',
    posBottom: 'Bottom',
    posLeft: 'Left',
    obsBookmark: 'Copy bookmark link with password',
    obsBookmarkHint:
      'The link connects automatically on open. The password inside is only obfuscated, not securely encrypted: use as a local bookmark only, do not share it.',
    entries: 'Entries',
    entryLabel: 'Label',
    color: 'Color for',
